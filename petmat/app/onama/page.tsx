        ...
        <div className="flex justify-center">
            <div className="md:w-2/3 w-[95%]">
                ...
                <div className="inline-flex items-center w-full">
                    <h1 className="w-[190px] px-3 font-semibold text-3xl text-gray-900 bg-white dark:text-white dark:bg-gray-900">O Petnici</h1>
                ...
                {/** O seminaru */}
                <div className="inline-flex items-center w-full">
                    <h1 className="w-[260px] px-3 font-semibold text-3xl text-gray-900 bg-white dark:text-white dark:bg-gray-900">O Seminaru</h1>
                    <hr className="w-full h-px my-8 bg-gray-200 border-0 dark:bg-gray-700" />
                </div>
                ...
                {/** Saradnicki tim */}
                <div className="inline-flex items-center w-full">
                    <h1 className="w-[350px] px-3 font-semibold text-3xl text-gray-900 bg-white dark:text-white dark:bg-gray-900">Saradnički tim</h1>
                    <hr className="w-full h-px my-8 bg-gray-200 border-0 dark:bg-gray-700" />
                </div>
                ...
                {/** Cesta pitanja */}
                <div className="inline-flex items-center w-full">
                    <h1 className="w-[300px] px-3 font-semibold text-3xl text-gray-900 bg-white dark:text-white dark:bg-gray-900">Česta pitanja</h1>
                    <hr className="w-full h-px my-8 bg-gray-200 border-0 dark:bg-gray-700" />
                </div>
                <h5 className="text-xl p-3 font-semibold text-gray-700 dark:text-white">Da li je potrebno određeno predznanje da bismo se prijavili za vaš seminar? </h5>
                ...
                <h5 className="text-xl p-3 font-semibold text-gray-700 dark:text-white">Na početku sam srednje škole / gimnazije tako da još uvek nisam siguran da li je matematika dobar izbor za mene. Da li bi treblo da se prijavim za seminar matematike? </h5>
                ...
                <h5 className="text-xl p-3 font-semibold text-gray-700 dark:text-white">Nemam ambicija prema takmičenjima iz matematike. Da li to znači da ne treba da se prijavim za vaš seminar?</h5>
                ...
                <h5 className="text-xl p-3 font-semibold text-gray-700 dark:text-white">Da li se na seminaru matematike rade samo zadaci?</h5>
                ...
                <h5 className="text-xl p-3 font-semibold text-gray-700 dark:text-white">Da li mogu da se prijavim na seminar ukoliko sam prvi razred?</h5>
                ...
                <h5 className="text-xl p-3 font-semibold text-gray-700 dark:text-white">Da li se mnogo ljudi prijavljuje iz Matematičke gimazije?</h5>
                ...
                <h5 className="text-xl p-3 font-semibold text-gray-700 dark:text-white">Koji su tipovi aktivnosti na seminaru?</h5>
                ...
                <h5 className="text-xl p-3 font-semibold text-gray-700 dark:text-white">Koliko se spava tokom seminara?</h5>
                ...
                <h5 className="text-xl p-3 font-semibold text-gray-700 dark:text-white">Kakva je komunikacija između polaznika i saradnika?</h5>
                ...
                <h5 className="text-xl p-3 font-semibold text-gray-700 dark:text-white">Da li je neophodno znanje engleskog jezika za seminar matematike?</h5>
